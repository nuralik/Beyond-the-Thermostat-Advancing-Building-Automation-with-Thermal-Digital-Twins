...
"""
DeepONet v0.5.5 — sensor importance and minimal active-set selection
====================================================================
...
PARAMS: Dict[str, Any] = {
    ...
    "experiment_name": "lab1_temp_humidity_v0.5.5_deep",
    "data_root": "./data",
    "lab": "lab1",
    "resolution": "5min",
    ...
    "weight_decay": 0.0,
    "num_workers": 0,
    "output_dir": "./deepOnet/runs/lab1data_v0.5.5",
...
def train(cfg: MutableMapping[str, Any]) -> Tuple[Path, Path]:
    ...
    print("=" * 92)
    print(f"DeepONet v0.5.5 | experiment={cfg['experiment_name']} | device={device}")
    print("=" * 92)
...
def save_timeseries_plots(outputs: EvalOutputs, protocol_name: str, display_name: str, masked_total: int) -> None:
    ...
    for c_idx, variable in enumerate(outputs.variable_names):
        ...
        fig.suptitle(
            f"DeepONet v0.5.5 — {variable.capitalize()} | {display_name} | masked_total={masked_total}",
            fontsize=12,
            fontweight="bold",
        )
        plt.tight_layout()
