...
"""
DeepONet v0.5.6 — sensor importance and minimal active-set selection
====================================================================
...
PARAMS: Dict[str, Any] = {
    ...
    "experiment_name": "lab1_temp_humidity_v0.5.6_deep",
    "data_root": "./data",
    "lab": "lab1",
    "resolution": "5min",
    ...
    "latent_dim": 128,
    "depth": 6,
    "activation": "gelu",  # "tanh", "relu", "gelu"
    "batch_size": 4096,
    "epochs": 150,
    "lr": 1e-3,
    ...
    "weight_decay": 0.0,
    "num_workers": 0,
    "output_dir": "./deepOnet/runs/lab1data_v0.5.6",
    ...
    # Output files.
    "eval_csv_name": "thermodt_eval_metrics_v053.csv",
    "eval_summary_name": "thermodt_eval_summary_v053.json",
    "eval_sensor_summary_name": "thermodt_eval_sensor_summary_v053.csv",
    "eval_protocol_summary_name": "thermodt_eval_protocol_summary_v053.csv",
    "sensor_importance_summary_name": "thermodt_sensor_importance_v053.csv",
    "backward_elimination_path_name": "thermodt_backward_elimination_path_v053.csv",
    "backward_elimination_candidates_name": "thermodt_backward_elimination_candidates_v053.csv",
    "exhaustive_subset_search_name": "thermodt_exhaustive_subsets_v053.csv",
...
def train(cfg: MutableMapping[str, Any]) -> Tuple[Path, Path]:
    ...
    print("=" * 92)
    print(f"DeepONet v0.5.6 | experiment={cfg['experiment_name']} | device={device}")
    print("=" * 92)
...
def save_timeseries_plots(outputs: EvalOutputs, protocol_name: str, display_name: str, masked_total: int) -> None:
    ...
    for c_idx, variable in enumerate(outputs.variable_names):
        ...
        fig.suptitle(
            f"DeepONet v0.5.6 — {variable.capitalize()} | {display_name} | masked_total={masked_total}",
            fontsize=12,
            fontweight="bold",
        )
        plt.tight_layout()
