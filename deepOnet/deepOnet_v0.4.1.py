...
"""
DeepONet v0.4.1 — sensor importance and minimal active-set selection
====================================================================
...
PARAMS: Dict[str, Any] = {
    ...
    "experiment_name": "lab1_temp_humidity_v0.4.1",
    "data_root": "./data",
    "lab": "lab1",
    "resolution": "5min",
    ...
    "weight_decay": 0.0,
    "num_workers": 0,
    "output_dir": "./deepOnet/runs/lab1data_v0.4.1",
    ...
    "enable_sensor_importance_protocols": True,
    "enable_backward_elimination": True,
    "backward_min_active_count": 1,
    "enable_exhaustive_small_k": True,
    ...
    # Output files.
    "eval_csv_name": "thermodt_eval_metrics_v041.csv",
    "eval_summary_name": "thermodt_eval_summary_v041.json",
    "eval_sensor_summary_name": "thermodt_eval_sensor_summary_v041.csv",
    "eval_protocol_summary_name": "thermodt_eval_protocol_summary_v041.csv",
    "sensor_importance_summary_name": "thermodt_sensor_importance_v041.csv",
    "backward_elimination_path_name": "thermodt_backward_elimination_path_v041.csv",
    "backward_elimination_candidates_name": "thermodt_backward_elimination_candidates_v041.csv",
    "exhaustive_subset_search_name": "thermodt_exhaustive_subsets_v041.csv",
...
def train(cfg: MutableMapping[str, Any]) -> Tuple[Path, Path]:
    ...
    print("=" * 92)
    print(f"DeepONet v0.4.1 | experiment={cfg['experiment_name']} | device={device}")
    print("=" * 92)
...
def build_eval_protocols(cfg: Mapping[str, Any], sensor_ids: Sequence[int]) -> List[EvalProtocol]:
    ...
    # Preserve special active-only sets from v0.3.2.
...
def save_timeseries_plots(outputs: EvalOutputs, protocol_name: str, display_name: str, masked_total: int) -> None:
    ...
    for c_idx, variable in enumerate(outputs.variable_names):
        ...
        fig.suptitle(
            f"DeepONet v0.4.1 — {variable.capitalize()} | {display_name} | masked_total={masked_total}",
            fontsize=12,
            fontweight="bold",
        )
        plt.tight_layout()
